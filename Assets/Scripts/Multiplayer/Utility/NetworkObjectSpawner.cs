...
{
	public static GameObject SpawnNewNetworkObject(GameObject prefab, bool destroyWithScene = true)
	{
#if UNITY_EDITOR
	...
	public static GameObject SpawnNewNetworkObject(GameObject prefab, Vector3 position, bool destroyWithScene = true)
	{
#if UNITY_EDITOR
		if (!NetworkManager.Singleton.IsServer)
		{
	...
	public static GameObject SpawnNewNetworkObject(GameObject prefab, Vector3 position, Quaternion rotation, bool destroyWithScene = true)
	{
#if UNITY_EDITOR
		if (!NetworkManager.Singleton.IsServer)
		{
	...
	public static GameObject SpawnNewNetworkObjectChangeOwnershipToClient(GameObject prefab, Vector3 position, ulong newClientOwnerId, bool destroyWithScene = true)
	{
#if UNITY_EDITOR
		if (!NetworkManager.Singleton.IsServer)
		{
